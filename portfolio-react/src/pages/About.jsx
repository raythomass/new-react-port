    ...
    return(
        <about>
            ...
            <section className="col-8">
                ...
                <p>I attended Grand Canyon University from 2017 to 2021 studying Advertising and Graphic Design as well as taking an extra semester geared towards
                    learning UI and UX best practices and programs. After a couple years I enrolled in Arizona State University's Full-Stack Web Development Bootcamp
                    where I was able to build a strong understanding and knwoledge of both front-end and back-end programs, best practices, and technologies.
                </p>
            </section>
        </about>
    )
